...
SHARED_SECTION_CRAFT_GUIDANCE = (
    "- Lead with the most useful answer, concrete detail, or decision-relevant point available.\n"
    "- Favor specific details from the provided context over broad or generic statements.\n"
    "- Develop ideas through detail, explanation, and reader implication rather than unsupported claims.\n"
    "- Vary sentence length and structure naturally, mixing concise statements with fuller explanation.\n"
    "- Do not announce the section topic or restate its purpose. Begin with the actual substance.\n"
    "- Avoid repeating the same paragraph shape, sentence opening, or conclusion across sections."
)
        ...
        "sections": [
            {
                ...
                "heading_level": "h1",
                "prompt_rules": (
                    "Write the category H1 and 1 to 2 concise intro paragraphs with 3 to 5 sentences total. "
